...
def load_files():
    ...
    df = pd.read_csv(os.path.dirname(os.path.abspath(__file__)) + '/fitting_dataset/v3_result_df_202401121430.csv')
    ...
    feed_com = pd.read_csv(os.path.dirname(os.path.abspath(__file__)) + '/fitting_dataset/feed_com.csv')
